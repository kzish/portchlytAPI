...
public class globals
{
    ...
    public static async Task<string> get_address_from_geolocation(double latitude,double longitude)
    {
        try
        {
            HttpClient client = new HttpClient();
            var resp = await client.GetAsync($"https://maps.googleapis.com/maps/api/geocode/json?latlng={latitude},{longitude}&key=AIzaSyCkHDfN-tHxIsL7WB6EAcd4m4F9KPtzP9E").Result.Content.ReadAsStringAsync();
